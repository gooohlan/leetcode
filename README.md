...
2. [数组](https://github.com/InkDP/leetcode/tree/master/Array)
   - [5.最长回文子串](https://github.com/InkDP/leetcode/blob/master/Arrray/5.go)
   - [26.删除有序数组中的重复项](https://github.com/InkDP/leetcode/blob/master/Arrray/26.go)
   - [27.移除元素](https://github.com/InkDP/leetcode/blob/master/Arrray/27.go)
